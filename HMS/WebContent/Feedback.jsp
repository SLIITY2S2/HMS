	  ...
	  <div class="card">
	   <div class="card-body">
	    <form action="<%=request.getContextPath()%>/#" method="post">
	     ...
	     <div class="form-group row">
	      <label for="suggestions" class="col-sm-2 col-form-label"><b>Suggestions</b></label>
	      <div class="col-sm-7">
	       <textarea class="form-control" name="suggestions" rows="8"  cols="50"></textarea>
	      </div>
	     </div>
	     ...
	     <div class="form-group row">
	      ...
	      <div class="col-sm-7">
	       <textarea class="form-control" name="complaints" rows="8"  cols="50"></textarea>
	      </div>
	     </div>
	     
	     
	     <button type="submit" class="btn-primary">
	     	<img alt="submit" src="./images/submit.jpg" class="img5">
	     </button>
	    </form>
	   </div>
	  </div>
