...
<html>
  <head>
	...
	<br><br><br>
	  ...
	  <a href="index.jsp"><img alt="close" src="./images/close.jpg" width="60px" height="60px"></a>
	  <div class="jumbotron">
	        ...
	        <form action="LoginServlet" method="post">
	          ...
	          <div class="custom-anchor">
	           <a href="./fogottenUNorPwd.jsp">Fogotten your username or password?</a>
	          </div>
	          <table>
	          	<tr>
	          		<td><button type="submit" class="btn-primary form-control">Login</button></td> 
	          		
	          		<td> <button type="submit" class="btn-primary form-control">Register</button></td>
	          	 </tr>
	          </table>
